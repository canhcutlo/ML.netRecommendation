...
namespace SpotifyRec_ConsoleApp1
{
    public partial class SpotifyRec
    {
        public const string RetrainFilePath =  @"C:\Users\trung\Downloads\ml-latest-small\ratings.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"movieId",inputColumnName:@"movieId",addKeyValueAnnotationsAsText:false)      
                                    ...
                                    .Append(mlContext.Recommendation().Trainers.MatrixFactorization(new MatrixFactorizationTrainer.Options(){LabelColumnName=@"rating",MatrixColumnIndexColumnName=@"userId",MatrixRowIndexColumnName=@"movieId",ApproximationRank=15,LearningRate=0.20150107212621257,NumberOfIterations=137,Quiet=true}))      
